package jhipster.application.config.timezone;

import jhipster.application.SampleApplicationApp;
import jhipster.application.repository.timezone.DateTimeWrapper;
import jhipster.application.repository.timezone.DateTimeWrapperRepository;
